...
from src.data_engineering.cramer_v import calculate_cramers_v_for_categorical_columns,calculate_cramers_v_for_ordinales_columns
...
def main():
    ...
    df_ord = calculate_cramers_v_for_ordinales_columns(X_train, y_train, ordinal_columns)
